...
int main(int argc, const char *argv[]) {
	@autoreleasepool {
		...
		NSLog(@"Copyright (C) 2014-2019 Linus Yang, Karen/あけみ (angelXwind), Diatrus");
		NSLog(@"** PLEASE DO NOT USE APPINST FOR PIRACY **");
		if (access(DPKG_PATH, F_OK) == -1) {
			NSLog(@"You seem to have installed appinst from an APT repository that is not diatr.us/nito (package ID com.linusyang.appinst).");
